...
function Group() {
  return (
    <div className="absolute contents left-0 top-0">
      <div className="absolute h-[913px] left-0 top-0 w-[843px]" data-name="Captura de Pantalla 2025-10-27 a la(s) 21.56.58 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-full left-0 max-w-none top-0 w-[192.41%]" src={imgCapturaDePantalla20251027ALaS2156581} />
        </div>
      </div>
