import svgPaths from "./svg-bbp1nierjz";
import imgRectangle689 from "figma:asset/3e23d288f1f4ad862433d9c71cf0528790d440f4.png";

function Group() {
  return (
    <div className="absolute h-[80.317px] left-[115px] top-[500px] w-[485.123px]">
...
export default function Component() {
  return (
    <div className="bg-[#232323] relative size-full" data-name="30">
      ...
      <p className="absolute font-['Parkinsans:Light',_sans-serif] font-light h-[20px] leading-[normal] left-[1141px] text-[#afafaf] text-[14px] top-[589px] tracking-[1.4px] w-[171px]">ejemplo@mail.com</p>
